...
knitr::include_graphics("images/d3logo.png")
```

## What is d3.js? 

```{r, echo=FALSE, out.width = "70%"}
knitr::include_graphics("images/D3js_necessary_langs.png")
```
...
knitr::include_graphics("images/d3_examples.png")
```
...
knitr::include_graphics("images/nytimes_stopandfrisk.gif")
```
...
```{r, echo=FALSE, out.width = "95%"}
knitr::include_graphics("images/nytimes_drought.gif")
```

## Periscope’s [U.S. Gun Deaths Viz](https://guns.periscopic.com/?year=2013)

```{r, echo=FALSE, out.width = "100%"}
knitr::include_graphics("images/periscope_gundeaths.gif")
```

## Bostock: [Uber Rides in SF](https://bost.ocks.org/mike/uberdata/)

```{r, echo=FALSE, out.width = "95%"}
knitr::include_graphics("images/uber_sf.gif")
```

## ThePudding: [Abortion Clinics](https://pudding.cool/2017/09/clinics/)

```{r, echo=FALSE, out.width = "85%"}
knitr::include_graphics("images/pudding_abortion.gif")
```

# Resources

```{r, echo=FALSE, out.width = "32%"}
knitr::include_graphics("images/murray_book_cover.jpg")
```
...
knitr::include_graphics("images/observable_viz_examples.png")
```
...
<div id="right">
  ```{r, echo=FALSE, out.width = "100%"}
  knitr::include_graphics("images/d3org_wiki.png")
  ```
</div>
...
<div id="right">
  ```{r, echo=FALSE, out.width = "100%"}
  knitr::include_graphics("images/blockbuilder_example.png")
  ```
</div>
...
```{r, echo=FALSE, out.width = "100%"}
knitr::include_graphics("images/hierachical_bar_chart_example.gif")
```

## Hierarchical Bar Chart (Code)

```{js, class.source='long', eval=FALSE}
<script>
...
```{r, echo=FALSE, out.width = "100%"}
knitr::include_graphics("images/tommek_Car.svg")
```
...
```{r, echo=FALSE, out.width = "40%"}
knitr::include_graphics("images/data_values_console.png")
```
...
```{r, echo=FALSE, out.width = "100%"}
knitr::include_graphics("images/square_visuals.jpg")
``` 
...
knitr::include_graphics("images/i-love-data-entry-said-no-one-ever.jpg")
```
...
```{r, echo=FALSE, out.width = "100%"}
knitr::include_graphics("images/console_table.png")
```
...
```{r, echo=FALSE, out.width = "100%"}
knitr::include_graphics("images/margin_convention.png")
```
...
```{r, echo=FALSE, out.width = "100%"}
knitr::include_graphics("images/data_join_D3.jpg")
```

## Enter, Update, Exit

```{r, echo=FALSE, out.width = "45%"}
knitr::include_graphics("images/bostock_joins.png")
```
...
knitr::include_graphics("images/domain-range-scale.jpg")
```
...
```{r, echo=FALSE, out.width = "100%"}
knitr::include_graphics("images/normalize_scale.png")
```
...
```{js, eval=FALSE, class.source='long'}
//Width and height
var w = 500;
var h = 250;
